        ...
        <div className="relative container mx-auto px-4 py-16 lg:py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <Button variant="outline" size="lg" className="border-white bg-transparent !text-white hover:bg-white hover:!text-blue-600 text-lg px-8 py-4 h-auto font-semibold">
                Login
              </Button>
            </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="border-white bg-transparent !text-white hover:bg-white hover:!text-blue-600 text-lg px-8 py-4 h-auto font-semibold">
              Learn More
            </Button>
          </div>
        </div>
