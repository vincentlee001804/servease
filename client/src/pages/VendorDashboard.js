                ...
                <form onSubmit={handleProfileSave} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <select name="businessType" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" defaultValue={dashboardData?.vendor?.businessType || ''}>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'].map((day, index) => {
                        ...
                        const dayData = dashboardData?.vendor?.operatingHours?.[dayKey];
                        const isEnabled = dayData?.enabled || (index < 5); // Default to Monday-Friday enabled
                        const openTime = dayData?.open || (index < 5 ? "09:00" : "");
                        const closeTime = dayData?.close || (index < 5 ? "18:00" : "");
